...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2020 at 04:43 AM
...
--
-- Table structure for table `mst_jenis_wilayah`
--

CREATE TABLE `mst_jenis_wilayah` (
  `id_jenis` int(11) NOT NULL,
  `nama` tinytext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `mst_jenis_wilayah`
--

INSERT INTO `mst_jenis_wilayah` (`id_jenis`, `nama`) VALUES
(1, 'kabupaten'),
(2, 'kota'),
(3, 'kelurahan'),
(4, 'desa');
...
--
-- Dumping data for table `mst_kabupaten`
--

INSERT INTO `mst_kabupaten` (`id_kab`, `id_prov`, `nama`, `id_jenis`) VALUES
...
INSERT INTO `mst_paket` (`ID`, `nama`, `kode`) VALUES
(1, 'sd', 'a'),
(2, 'smp', 'b'),
(3, 'sma', 'c');
...
INSERT INTO `mst_provinsi` (`id_prov`, `nama`) VALUES
('11', 'Aceh'),
('12', 'Sumatera Utara'),
('13', 'Sumatera Barat'),
('14', 'Riau'),
...
INSERT INTO `mst_tingkat_pendidikan` (`ID`, `nama`) VALUES
(1, 'sd'),
(2, 'smp'),
(3, 'sma');
...
CREATE TABLE `tbl_alamat` (
  ...
  `dusun` varchar(200) DEFAULT NULL,
...
--
-- Table structure for table `tbl_contact_siswa`
--

CREATE TABLE `tbl_contact_siswa` (
  `ID` int(11) NOT NULL,
  `id_siswa` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_kip_siswa`
--

CREATE TABLE `tbl_kip_siswa` (
  `ID` int(11) NOT NULL,
  `id_siswa` int(11) NOT NULL,
...
CREATE TABLE `tbl_pekerjaan` (
  ...
  `thn_keluar` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `tbl_pendidikan_keluarga`
--

CREATE TABLE `tbl_pendidikan_keluarga` (
  `ID` int(11) NOT NULL,
  `id_keluarga` int(11) NOT NULL,
  `pendidikan` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `tbl_pendidikan_siswa`
--

CREATE TABLE `tbl_pendidikan_siswa` (
  `ID` int(11) NOT NULL,
  `id_siswa` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_rencana_belajar`
--

CREATE TABLE `tbl_rencana_belajar` (
  `ID` int(11) NOT NULL,
  `id_siswa` int(11) NOT NULL,
...
CREATE TABLE `tbl_siswa` (
  ...
  `kewarnegaraan` varchar(100) DEFAULT NULL,
  ...
  `regist_key` varchar(128) DEFAULT NULL,
  `status_regist` int(11) DEFAULT NULL,
...
--
-- Indexes for table `tbl_contact_siswa`
--
ALTER TABLE `tbl_contact_siswa`
  ADD PRIMARY KEY (`ID`);
...
--
-- Indexes for table `tbl_kip_siswa`
--
ALTER TABLE `tbl_kip_siswa`
  ADD PRIMARY KEY (`ID`);
...
--
-- Indexes for table `tbl_pendidikan_keluarga`
--
ALTER TABLE `tbl_pendidikan_keluarga`
  ADD PRIMARY KEY (`ID`);

--
-- Indexes for table `tbl_pendidikan_siswa`
--
ALTER TABLE `tbl_pendidikan_siswa`
  ADD PRIMARY KEY (`ID`);

--
-- Indexes for table `tbl_rencana_belajar`
--
ALTER TABLE `tbl_rencana_belajar`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `tbl_contact_siswa`
--
ALTER TABLE `tbl_contact_siswa`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tbl_kip_siswa`
--
ALTER TABLE `tbl_kip_siswa`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tbl_pendidikan_keluarga`
--
ALTER TABLE `tbl_pendidikan_keluarga`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_pendidikan_siswa`
--
ALTER TABLE `tbl_pendidikan_siswa`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_rencana_belajar`
--
ALTER TABLE `tbl_rencana_belajar`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
