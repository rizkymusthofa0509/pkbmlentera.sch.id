						...
						<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
							...
							<tr>
								<td align="center" valign="top">
									...
									-->
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#c2131c">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<!--
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Attendance System</h1>
																	...
																	<td align="left" valign="top" class="flexibleContainerBox">
																		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 100%;">
																			<tr>
																				<td align="left" class="textContent">
																					<center>
																						<img src="https://cdn-brilio-net.akamaized.net/news/2020/02/27/179489/thumbnail-aplikasi-ini-permudah-absensi-kerja-cocok-buat-kamu-yang-mobile-200227i.jpg" style="width: 80%;">
																					</center>
																					<br>
																					<center>
																						<font size="4">
																							Terimakasih Bapak/ibu,<br>
																							sudah melakukan absensi tepat pukul
																						</font>
																					</center>
																				</td>
																			</tr>
												...
												<table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
													<tr>
														<td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
															...
															<!-- CONTENT TABLE // -->
															<font size="1">01 Januari 2020</font>
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #c2131c;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<h1 style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:30px;line-height:135%;text-align: center;" >
																			07:00
																		</h1>
