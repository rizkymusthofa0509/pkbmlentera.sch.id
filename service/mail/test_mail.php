...
$open_config_email = mysqli_fetch_array(mysqli_query($konek,"SELECT * FROM mail_settings"));

$cek_data = mysqli_query($konek,"SELECT * FROM tbl_users_forgot WHERE server_send='0' LIMIT 1");
...
// Subjek email
$mail->Subject = '[KitaLearning] Security incident: your password was reset ';
			...
			<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable" style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;">
				<tr>
					<td align="center" valign="top" id="bodyCell">
						...
						-->
						<table bgcolor="#E1E1E1" border="0" cellpadding="0" cellspacing="0" width="800" id="emailHeader">
								...
								<td align="center" valign="top">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<table border="0" cellpadding="10" cellspacing="0" width="800" class="flexibleContainer">
													<tr>
														<td valign="top" width="800" class="flexibleContainerCell">
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Insiden Keamanan</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">Reset Password</h2>
								...
								<td align="center" valign="top">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<table border="0" cellpadding="30" cellspacing="0" width="800" class="flexibleContainer">
													<tr>
														<td valign="top" width="800" class="flexibleContainerCell">
																...
																<tr>
																	<td align="left" valign="top" class="flexibleContainerBox">
																		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 100%;">
																			<tr>
																				<td align="left" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Halo, </h3>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
																						Kami telah me-reset login password akun anda sebagai bentuk pencegahan atas insiden keamanan yang baru-baru ini terjadi. 
																						Kami menanggapi kasus ini dengan serius dan akan menjelaskan apa yang terjadi serta langkah apa yang telah kami ambil untuk 
																						memastikan keamanan akun Anda. 
																						<br><br>
																						Silakan klik link berikut untuk membuat password member area yang baru.
																						<br><br>
																						<a href="'.$link.'">'.$link.'</a>
																						<br><br><br>
																						Atau anda juga dapat menekan tombol dibawah ini untuk melakukan perubahan password.
																					</div>
																				</td>
																			</tr>
																		</table>
															...
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="'.$link.'" target="_blank">Click Here!</a>
																	</td>
																</tr>
															</table>
														</td>
...
if(!$mail->send()){
    ...
    $update = mysqli_query($konek,"UPDATE tbl_users_forgot SET server_send='1' WHERE id='$det[id]' ");
}
