...
$mail->SMTPAuth 	= true;
$mail->Username 	= 'info.poinku@gmail.com';
$mail->Password 	= 'Rizky321#@!';
$mail->SMTPSecure   = 'tls';
$mail->Port 		= 587;

$mail->setFrom('info@poinku.id', 'POINKU');
$mail->addReplyTo('info@poinku.id', "POINKU");
...
// Subjek email
$mail->Subject = '[Poinku.id] Reset Password Berhasil. ';
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:white;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">POINKU.ID</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">Notification System</h2>
																...
																<tr>
																	<td align="left" valign="top" class="flexibleContainerBox">
																		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 100%;">
																			<tr>
																				<td align="left" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:center;">Permintaan Reset Password </h3>
																					<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
																						Hallo Saudara '.$det['nama_mitra'].', anda telah melakukan permintaan reset password pada aplikasi Poinku.id.
																						<br><br>
																						Kami telah melakukan reset password anda dengan <b>12345678</b>
																						<br>
																						Segera lakukan update password, untuk mengamankan akun anda.
																					</div>
																				</td>
																			</tr>
																		</table>
												...
												<table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
													<tr>
														<td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
															...
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="https://poinku.id/login" target="_blank">Confirmation</a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
															<br>
															Link Manual : <br>
															<a href="https://poinku.id/login">https://poinku.id/login</a>
															<br><br><br><br>
															<b>Salam,</b>
															<br><br><br>
															IT Department.
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			<div>Copyright &#169; 2020 <a href="" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:white;"> Poinku.id</span></a>. All&nbsp;rights&nbsp;reserved.</div>
