...
<div class="container card mt-5 mb-5">
    <h3 class="well">A. Data Diri Siswa</h3>
    <form method="post" class="form-horizontal pb-3" role="form" action="<?= base_url('regist/prosesRegist') ?>">
        <div class="form-group">
            <label for="firstName" class="col-sm-2 control-label">Nama Lengkap</label>
            <div class="col-sm-10">
                <input type="text" id="nama_siswa" name="nama_siswa" placeholder="Nama Lengkap" class="form-control">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" id="tmp_lahir" name="tmp_lahir" placeholder="Tempat lahir" class="form-control">
            </div>
            <div class="col-sm-5">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="nik" id="nik" placeholder="Last Name" class="form-control">
            </div>
        </div>
        <div class="form-group">
            <label for="akta" class="col-sm-2 control-label">No. Akta Kelahiran</label>
            <div class="col-sm-10">
                <input type="text" name="akta" id="akta" placeholder="Last Name" class="form-control">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-sm-2">
                        <label class="radio-inline">
                            <input type="radio" id="" name="kps" value="1">Ya
                        </label>
                    </div>
                    <div class="col-sm-2">
                        <label class="radio-inline">
                            <input type="radio" id="" name="kps" value="0">Tidak
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="nkps" id="telp" placeholder="No. KPS" class="form-control">
            </div>
        </div>
        <div class="form-group">
            <label for="telp" class="col-sm-2 control-label">Transportasi</label>
            <div class="col-sm-10">
                <input type="text" name="transportasi" id="telp" placeholder="Umum/Jalan Kaki/Sepeda" class="form-control">
            </div>
        </div>
        <div class="form-group">
            <label for="telp" class="col-sm-2 control-label">Kebutuhan Khusus</label>
            <div class="col-sm-10">
                <input type="text" name="siswa_khusus" id="telp" placeholder="" class="form-control">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    <input type="text" name="tinggi" id="telp" placeholder="Tinggi" class="form-control">
                    <span class="input-group-addon" id="basic-addon1">cm</span>
                    <input type="text" name="berat" id="telp" placeholder="Berat" class="form-control">
