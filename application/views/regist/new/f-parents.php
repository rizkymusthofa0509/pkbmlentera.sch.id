                      ...
                      <div class="row">
                        <div class="col-md-6 col-lg-6">
                          <div class="form-group">
                              ...
                              <input type="date" class="form-control" name="lahir_ortu[]" />
                          </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                          <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-sm-3">
                                  <label class="radio-inline">
                                      <input type="radio" id="" name="keterangan_ortu_1" value="P" checked>
                                      <label>Ya</label>
                                  </label>
                              </div>
                              <div class="col-sm-3">
                                  <label class="radio-inline">
                                      <input type="radio" id="" name="keterangan_ortu_1" value="W">
                                      <label>Tidak</label>
                                  </label>
                              </div>
                            </div>
                        ...
                        <div class="col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-sm-3">
                                  <label class="radio-inline">
                                      <input type="radio" id="" name="keterangan_ortu_2" value="P" checked>
                                      <label>Ya</label>
                                  </label>
                              </div>
                              <div class="col-sm-3">
                                  <label class="radio-inline">
                                      <input type="radio" id="" name="keterangan_ortu_2" value="W">
                                      <label>Tidak</label>
                                  </label>
                              </div>
                            </div>
                    ...
                    <div class="parent">
                      ...
                      <div class="row">
                        <div class="col-md-12 col-lg-12">
                          <div class="form-group">
                              ...
                              <input type="date" class="form-control" name="wali" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-12 col-lg-12">
                          <div class="form-group">
                              <label class="control-label">Contact</label>
                              <input type="text" class="form-control" name="contact_wali"/>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                          <div class="form-group">
                              <label class="control-label">Pekerjaan</label>
                              <input type="text" class="form-control" name="kerja_wali"/>
                          </div>
                        </div>
                        <div class="col-md-4 col-lg-4">
                          <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-md-12 col-lg-12">
                          <div class="form-group">
                              <label class="control-label">Kebutuhan Khusus</label>
                              <input type="text" class="form-control" name="khusus_wali"/>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-12 col-lg-12">
                          <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-sm-3">
                                  <label class="radio-inline">
                                      <input type="radio" id="" name="keterangan_ortu_3" value="P">
                                      <label>Ya</label>
                                  </label>
                              </div>
                              <div class="col-sm-3">
                                  <label class="radio-inline">
                                      <input type="radio" id="" name="keterangan_ortu_3" value="W">
                                      <label>Tidak</label>
                                  </label>
                              </div>
                            </div>
