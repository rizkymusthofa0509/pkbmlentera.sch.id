...
<head>
  ...
  <title><?= $title ?></title>
  <link rel="shortcut icon" href="<?= base_url() ?>assets/logo/icon.png" type="image/png">
...
<body class="layout-top-nav skin-blue fixed">
<div class="wrapper">
      ...
      <div class="container" style="width: 100%;">
        <div class="navbar-header">
          <div class="col-md-12" style="background-color: white;
                                        ...
                                        border-radius: 0px;
                                        ">
          <img src="<?= base_url() ?>assets/logo/pkbm.png" width="100px;" style="margin-top: 5px;"> 
          </div>
...
<?php $this->load->view('panel/menu'); ?>
        ...
        <div class="navbar-custom-menu">
          <form action="<?= base_url() ?>panel/home" class="navbar-form navbar-left" role="search">
            <div class="form-group">
              <input type="text" class="form-control" name="filter" id="navbar-search-input" placeholder="Cari Nama Siswa..." style="width: 200px;">
            </div>
          </form>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="<?= base_url() ?>panel/auth/logout" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
  ...
  <div class="content-wrapper bg" >
    ...
    <section class="content">
        <div class="row">
          <div class="col-md-12">
            <?php $this->session->userdata('notif'); ?>
          </div>
        </div>
      <div class="row"> 
         <div class="col-md-12">
  ...
  <footer class="main-footer">
    <div class="container">
      ...
      <strong>Copyright &copy; 2021 PKBM Lentera.</strong> 
    </div>
    <!-- /.container -->
  </footer>
</div>
