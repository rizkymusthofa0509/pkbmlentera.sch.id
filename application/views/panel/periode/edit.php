 <form method="POST" action="<?= base_url('panel/periode/pages/update'); ?>">  
          ...
          <tr>
             ...
             <td>
               <select class="form-control select2me" name="status" id="status" required > 
                 ...
                 <option value="0" <?php if($detail['status']=='0'){echo 'selected';}  ?>>Tidak Aktif</option>
               </select>
             </td> 
           </tr>
           <tr>
             ...
             <td>
                <input type="date" name="start" id="start" class="form-control" value="<?=$detail['start'];?>" >
             </td>
             <td class="bold">Akhir Periode</td>
             <td>
               <input type="date" name="finish" id="finish" class="form-control" value="<?=$detail['start'];?>" >
             </td>
           </tr>
