                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand-box d-flex align-items-left">
                        <a href="index.html" class="logo">
                            <img src="<?= base_url() ?>temp/admin/<?= base_url() ?>temp/admin/assets/images/logo-light.png"/>
                        </a>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <button type="button" class="btn btn-light d-none d-lg-block ml-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                                ...
                                <div data-simplebar style="max-height: 230px;">
                                    <a href="" class="text-reset notification-item">
                                        <div class="media">
                                            <img src="<?= base_url() ?>temp/admin/assets/images/users/avatar-2.jpg"
                                                class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="media-body">
                                                <h6 class="mt-0 mb-1">Samuel Coverdale</h6>
                                                <p class="font-size-14 mb-1">You have new follower on Instagram</p>
                                    ...
                                    <a href="" class="text-reset notification-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="font-size-14 mb-1">Latest version of admin is now available. Please download here.</p>
                                    ...
                                    <a href="" class="text-reset notification-item">
                                        <div class="media">
                                            <img src="<?= base_url() ?>temp/admin/assets/images/users/avatar-3.jpg"
                                                class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="media-body">
                                                <h6 class="mt-0 mb-1">Victoria Mendis</h6>
                                                <p class="font-size-14 mb-1">Just upgraded to premium account.</p>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-components" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="feather-briefcase"></i>UI Elements <div class="arrow-down"></div>
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="feather-copy"></i>Pages <div class="arrow-down"></div>
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-forms" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="feather-disc"></i>Forms <div class="arrow-down"></div>
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-charts" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="feather-bar-chart-2"></i>Charts <div class="arrow-down"></div>
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-more" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="feather-book-open"></i>More <div class="arrow-down"></div>
                                    </a>
