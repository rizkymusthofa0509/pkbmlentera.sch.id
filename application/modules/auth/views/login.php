...
<head>
    ...
    <meta content="Muri Digital" name="author" />
...
<body>
                                     ...
                                     <div class="card card-animate">
                                        <div class="card-body">
                                            <div class="text-center mb-4 mt-3">
                                                <a href="index.html">
                                                    <span><img src="<?= base_url() ?>assets/images/<?= webinfo('logo') ?>" alt="Logo" /></span>
                                                </a>
                                            </div>
                                            <form action="<?= base_url() ?>auth/prosess" method="POST" class="p-2">
                                                <div class="form-group">
                                                    <label for="emailaddress">Email address</label>
                                                    <input class="form-control" name="username" type="email" id="emailaddress" required="" placeholder="E-mail" autocomplate="false">
                                                </div>
                                                <div class="form-group"> 
                                                    <label for="password">Password</label>
                                                    <input class="form-control" name="password" type="password" required="" id="password" placeholder="Enter your password" autocomplate="false">
                                                </div>
    ...
    <script src="<?= base_url() ?>temp/admin/assets/js/metismenu.min.js"></script>
